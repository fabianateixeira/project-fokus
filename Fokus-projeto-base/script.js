...
const simboloPlayPause = document.querySelector('.app__card-primary-butto-icon');
...
function iniciarOuPausar() {
    ...
    simboloPlayPause.setAttribute('src', `/imagens/pause.png`);
}

function zerar() {
    clearInterval(intervaloId);
    pausarBt.textContent = "Começar";
    simboloPlayPause.setAttribute('src', `/imagens/play_arrow.png`);
    intervaloId = null;
}
